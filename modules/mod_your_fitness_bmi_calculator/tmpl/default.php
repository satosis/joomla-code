...
<div class="uk-grid uk-container-center uk-flex-center" style="margin: 0px;">
...
<div class="uk-grid-width-medium-4-10 uk-grid-width-small-4-10 uk-grid-width-large-4-10 uk-grid-width-xlarge-4-10" >
        <div class="tt-border-form">
    <form>
