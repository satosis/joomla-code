<article class="uk-article" <?php if ($permalink) echo 'data-permalink="'.$permalink.'"'; ?>>
	...
	<?php if ($image && $image_alignment != 'none') : ?>
		<?php if ($url) : ?>
            <?php 
            echo '<div class="tt-width-title uk-align-center" style="margin-top: 80px; margin-bottom: 0px;">
                <p style="font-size: 30px; text-transform: uppercase; font-weight: 300; line-height: 1.2;"><a href="'
        ...
        <?php else : ?>
            <?php 
            echo '<div class="uk-width-8-10 uk-align-center" style="margin-top: 80px; margin-bottom: 0px;">
