...
if($warp['config']->get('article_style') == 1){
    echo $warp['template']->render('blog_article', $args);
}elseif($warp['config']->get('article_style') == 0){
    echo $warp['template']->render('default_article', $args);   
}