...
<div class="uk-grid uk-flex-center" data-uk-slider="{infinite: true, autoplay: true, autoplayInterval: '7000'}" >       
    <div class="uk-grid-width-small-1-1 uk-width-medium-8-10 uk-grid-width-large-8-10 uk-grid-width-xlarge-8-10">
       <div class="uk-slider-container uk-grid-width-small-1-1">
            <ul class="uk-slider uk-grid-width-small-1-1 uk-grid-width-medium-1-2 uk-grid-width-xlarge-1-4">
               <?php foreach ($list as $item) : ?>
                        <li class="uk-grid-width-small-1-1 uk-grid-width-medium-1-1 uk-grid-width-xlarge-1-1" style="background-color: #959595;"><?php echo $item->introtext; ?></li>     
               <?php endforeach; ?> 
            </ul>
        </div> 
    </div>
