...
<div class="akslider-module <?php echo $moduleclass_sfx; ?>">
    <div class="uk-slidenav-position" data-uk-slideshow="{<?php echo implode(", ", $slideshow_cfg); ?>}">
        ...
        <?php if($params->get('slidenav_btn')) : ?>
            <a href="" class="uk-slidenav uk-slidenav-contrast uk-slidenav-previous box-classes uk-hidden-small" data-uk-slideshow-item="previous"></a>
            <a href="" class="uk-slidenav uk-slidenav-contrast uk-slidenav-next box-classes uk-hidden-small" data-uk-slideshow-item="next"></a>
        <?php endif; ?>
        <?php if($params->get('slidenav')) : ?>
            <ul class="uk-dotnav uk-dotnav-contrast uk-flex-center uk-position-bottom uk-text-center">
                <?php $counter = 0; ?>
                <?php foreach ($list as $item) : ?>
