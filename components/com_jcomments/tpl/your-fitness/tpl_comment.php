...
?>
<span class="text-autor"><?php echo $comment->author?></span>
<?php
				}
?>
<?php
...
<?php
					if ($this->getVar('button-reply') == 1) {
?>
<a href="#" onclick="jcomments.showReply(<?php echo $comment->id; ?>); return false;" style="text-transform: uppercase; margin-left: 10px; font-size: 14px; color: #ff3030;"><?php echo JText::_('BUTTON_REPLY'); ?></a>
<?php
						if ($this->getVar('button-quote') == 1) {
?>
 | <a href="#" onclick="jcomments.showReply(<?php echo $comment->id; ?>,1); return false;" style="text-transform: uppercase; font-size: 14px; color: #ff3030;"><?php echo JText::_('BUTTON_REPLY_WITH_QUOTE'); ?></a> | 
<?php
						}
					}
					if ($this->getVar('button-quote') == 1) {
?>
<a href="#" onclick="jcomments.quoteComment(<?php echo $comment->id; ?>); return false;" style="text-transform: uppercase; font-size: 14px; color: #ff3030;"><?php echo JText::_('BUTTON_QUOTE'); ?></a>
<?php
					}
