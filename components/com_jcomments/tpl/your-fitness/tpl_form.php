...
?>
<h4 style="margin-top: -5px; margin-bottom: 35px; margin-left: 40px; color: #303030; font-size: 24px; text-transform: uppercase;">Leave a comment</h4>
...
<p>
	<span>
		<input id="comments-form-name" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" placeholder="NAME" />
...
<p>
	<span>
		<textarea id="comments-form-comment" name="comment" cols="65" rows="8" tabindex="5" placeholder="COMMENTS"></textarea>
	</span>
</p>
<?php
...
<div id="comments-form-buttons">
	<div class="btn" id="comments-form-send"><a href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?></a></div>
	<div class="btn-2" id="comments-form-cancel" style="display:none;"><a href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a></div>
